<x-admin.layout :notifs="$adminNotifs">
  ...
  <section class="survey-card h-fit">
    ...
    <div class="row-top row">
        <div class="col-8">
            <div class="container">
            <h1 class="text-center"><strong>Menu Plan for Week <span class="text-yellow-500"> [num]</span> of <span class="text-yellow-500">[Month]</span></strong></h1>
                ...
                <div class="container col-sm-4 col-md-7 col-lg-4 mt-2">
                  <div class="card">
                    ...
                    <div class="form-inline mx-4 space-x-60">
                      <button class="button-sec bg-white mr-4" id="previous"><i class="fa-solid fa-angles-left fa-lg"></i></button>
                      <button class="button-sec bg-white" id="next"><i class="fa-solid fa-angles-right fa-lg"></i></button>
                    </div>
