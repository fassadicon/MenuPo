<x-admin.layout :notifs='$adminNotifs'>
    ...
    <a href="/admin/students/trash" class="btn btn-warning mb-2"><i class="fas fa-user-times"></i>&nbsp;Archived Student
        Accounts</a>
    <a href="/admin/PDFQR" class="btn btn-info mb-2"><i class="bi bi-qr-code"></i></i>&nbsp;Download QR Codes</a>
    ...
    <div class="container">
        ...
        <a href="/admin/logs/studentAccount" class="btn btn-info mb-2"><i class="fas fa-file-alt"></i>&nbsp;Student
            Changes Logs</a>
        <a href="/admin/logs/bmiChanges" class="btn btn-info mb-2"><i class="fas fa-file-alt"></i>&nbsp;BMI Changes
            Logs</a>
    </div>
