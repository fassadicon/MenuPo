  ...
  <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li>
      <a href="charts-echarts.html">
        ...
        <li>
                <a href="/admin/admins" class="nav-link collapsed" title="Admin Management" id="sidebarLink">
                    <i class="fas fa-user-cog"></i></i><span>Admin</span>
                </a>
            </li>
        @endif
        <li>
            <a href="/admin/guardians" class="nav-link collapsed" title="Parent Management" id="sidebarLink">
                <i class="fas fa-user-alt"></i><span>Parents</span>
            </a>
        </li>
        <li>
            <a href="/admin/students" class="nav-link collapsed" title="Student Management" id="sidebarLink">
                <i class="fas fa-user-graduate"></i><span>Students</span>
            </a>
        </li>
        <li>
            <a href="/admin/imports" class="nav-link collapsed" title="Mass Account Creation" id="sidebarLink">
                <i class="fa-solid fa-people-roof"></i><span>Mass Creation</span>
            </a>
        </li>
        @if (auth()->user()->role == 2)
            <li>
                <a href="/admin/imports/adminAccounts" class="nav-link collapsed" title="Mass Admin Creation" id="sidebarLink">
