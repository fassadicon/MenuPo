        ...
        <div class="container md:col-span-2 items-center max-w-screen-xl px-8 mx-auto xl:px-5">
          <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="flex w-full md:w-1/2 md:px-3">
              ...
              > -->
                <h3 class="text-xl font-bold text-gray-800">SCHOOL CANTEEN ANNOUNCEMENTS
                </h3>
                       ...
                       <div class="">
                          ...
                          <div
                             ...
                             <div class="absolute top-1/2 w-full flex justify-between z-20">
                                <label for="carousel-3" class="inline-block text-yelalow-600 cursor-pointer -translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                       ...
                       <div class="">
                          ...
                          <div
                             ...
                             <div class="absolute top-1/2 w-full flex justify-between z-20">
                                ...
                                <label for="carousel-3" class="inline-block text-yellow-600 cursor-pointer translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                   <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                      <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z" clip-rule="evenodd" />
                                   </svg>
                                </label>
