...
function openClose() {
  const [day,t] = new Date().toLocaleString('en-en', {weekday:"short",hour: '2-digit',minute:'2-digit', hour12: false, timeZone: 'Asia/Manila' }).replace(":","").split(" "),
         time = +t; // make time numeric
  document.querySelectorAll("div").forEach(d=>d.style.display=""); // make all divs visible at first
  // console.log(time);
  document.getElementById(time>=(day==="Sun"?1000:700) && time<=(day==="Fri"?1930:1900)?"closed":"open").style.display = "none";
}
